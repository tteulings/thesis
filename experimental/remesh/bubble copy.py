...
class Bubble(TypedGraph):
    def __init__(
        ...
        print(positions[2].shape)
        print(source_faces.shape)
        ...
        if target_acceleration:
            ...
            center_target = centroid(positions[2],remesh_result.faces.transpose())- centroid(remesh_result.positions,  remesh_result.faces.transpose())
    ...
    def remesh(self, instructions: NDArray[np.ubyte]) -> "Bubble":
        ...
        self.velocity = self.node_sets["bubble"]["velocity"].attr[:, :3]
