...
wandb.init(
    ...
    config={
    "architecture": "Fixed predicted input, only backpropagate end, new optimizer vecadam",
    **vars(args),
    }
)
...
optimizer = Adam(
    model.parameters(), lr=args.learning_rate, amsgrad=False, betas=(0.98, 0.98)
)
