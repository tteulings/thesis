        ...
        for sequence in sequence_loader:
            ...
            for (count, bubble) in enumerate(bubble_loader):
                ...
                if count % args.tbptt == 0:
                    print(sequence_loss/args.tbptt)
                ...
                sequence_loss += float(one_step_loss.detach())
                ...
                if (count + 1) % args.print_every == 0:
                    print(
                        f"{model.epoch.item():<7}{train_loss/args.print_every:<18.8e}"f"{f'{rel_error/args.print_every}': <37}
